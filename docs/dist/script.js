var userChoices = {
    ...
    `;
      ...
      document.getElementById("cookbutton").onclick = function() {
            switch (resultTitle) {
                case '等級 S':
                    window.location.href = "https://cosmozhan.github.io/GraduationPJ/recipechoice-gp/dist/index.html#rankS"; // 等級S的頁面
                    break;
                case '等級 A':
                    window.location.href = "https://cosmozhan.github.io/GraduationPJ/recipechoice-gp/dist/index.html#rankA"; // 等級A的頁面
                    break;
                case '等級 B':
                    window.location.href = "https://cosmozhan.github.io/GraduationPJ/recipechoice-gp/dist/index.html#rankB"; // 等級B的頁面
                    break;
                case '等級 F':
                    window.location.href = "https://cosmozhan.github.io/GraduationPJ/recipechoice-gp/dist/index.html#rankF"; // 等級F的頁面
                    break;
                default:
                    alert("無法識別等級結果");
                    break;
